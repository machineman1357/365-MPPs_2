...
export default class WaitingRoom extends Phaser.Scene {
    ...
    create() {
        ...
        //     fontStyle: "bold",
        // });
        scene.roomKeyText = scene.add.dom(210, 250, "div", {
            "color": "#00ff00",
            "font-size": "20px",
            "font-style": "bold",
        });
        ...
        scene.socket.on("roomCreated", function (roomKey) {
            ...
            console.log(scene.roomKeyText);
            scene.roomKeyText.setText(roomKey);
        });

        scene.socket.on("keyNotValid", function () {
            console.log("socket message: keyNotValid");
            scene.notValidText.setText("Invalid Room Key");
        });
        scene.socket.on("keyIsValid", function (input) {
            console.log("socket message: keyIsValid");
